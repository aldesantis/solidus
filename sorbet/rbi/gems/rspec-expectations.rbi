...
module RSpec::Matchers
  ...
  def have_attributes(*expected, &block_arg); end
...
class InvalidName___Class_0x00___Differ_28
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_29
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_30
