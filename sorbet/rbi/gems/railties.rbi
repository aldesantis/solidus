...
module Rails::Generators::Database
  ...
  def gem_for_database(database = nil); end
  def initialize(*arg0); end
...
class Rails::Generators::AppBase < Rails::Generators::Base
  ...
  def empty_directory_with_keep_file(destination, config = nil); end
  ...
  def generate_spring_binstubs; end
  ...
  def rails_template=(arg0); end
  def rails_version_specifier(gem_version = nil); end
  def run_bundle; end
  def run_webpack; end
  def self.add_shared_options_for(name); end
...
class Anonymous_Struct_3 < Struct
  def comment; end
  def comment=(_); end
  def commented_out; end
  def commented_out=(_); end
  def name; end
  def name=(_); end
  def options; end
  def options=(_); end
...
class Rails::Generators::AppBase::GemfileEntry < Anonymous_Struct_3
  def initialize(name, version, comment, options = nil, commented_out = nil); end
  def self.github(name, github, branch = nil, comment = nil); end
  def self.path(name, path, comment = nil); end
  def self.version(name, version, comment = nil); end
  def version; end
end
module Rails::ActionMethods
  def chmod(*args, &block); end
  def copy_file(*args, &block); end
  def create_file(*args, &block); end
  def directory(*args, &block); end
  def empty_directory(*args, &block); end
  def empty_directory_with_keep_file(*args, &block); end
  def initialize(generator); end
  def inside(*args, &block); end
  def method_missing(meth, *args, &block); end
  def options; end
  def shebang(*args, &block); end
  def template(*args, &block); end
end
class Rails::AppBuilder
  def app; end
  def bin; end
  def bin_when_updating; end
  def config; end
  def config_target_version; end
  def config_when_updating; end
  def configru; end
  def credentials; end
  def database_yml; end
  def db; end
  def gemfile; end
  def gitignore; end
  def lib; end
...
class Rails::Generators::AppGenerator < Rails::Generators::AppBase
  ...
  def generate_bundler_binstub(*arg0); end
  def generate_spring_binstubs(*arg0); end
  def get_builder_class; end
  def initialize(*args); end
  def run_after_bundle_callbacks; end
  def run_bundle(*arg0); end
  def run_webpack(*arg0); end
  def self.banner; end
  def set_default_accessors!(*arg0); end
  def update_active_storage; end
  def update_bin_files; end
  def update_config_files; end
end
class Rails::Generators::ARGVScrubber
  def handle_invalid_command!(argument, argv); end
  def handle_rails_rc!(argv); end
  def handle_version_request!(argument); end
  def initialize(argv = nil); end
  def insert_railsrc_into_argv!(argv, railsrc); end
  def prepare!; end
  def railsrc(argv); end
  def read_rc_file(railsrc); end
  def self.default_rc_file; end
end
