...
class ActiveRecord::Base
  ...
  def self._validators?; end
  def self.acts_as_paranoid(options = nil); end
...
class Spree::RefundReason < Spree::Base
  def self.default_scope_override; end
end
module Spree::RefundReason::GeneratedRelationMethods
  def arel_table(*args, &block); end
end
class Spree::ReturnReason < Spree::Base
  def self.default_scope_override; end
end
module Spree::ReturnReason::GeneratedRelationMethods
  def arel_table(*args, &block); end
end
class Spree::Role < Spree::Base
  def self.default_scope_override; end
end
class Spree::ShippingCategory < Spree::Base
  def self.default_scope_override; end
end
class Object < BasicObject
  def create_states(subregions, country); end
end
class Spree::StockLocation < Spree::Base
  def self.default_scope_override; end
end
class Spree::PaymentMethod < Spree::Base
  def self.default_scope_override; end
end
module Spree::PaymentMethod::GeneratedRelationMethods
  def paranoia_scope(*args, &block); end
end
class Spree::Store < Spree::Base
  def self.default_scope_override; end
end
class Spree::Zone < Spree::Base
  def self.default_scope_override; end
end
