...
class Spree::Api::BaseController < ActionController::Base
  def _cancan_skipper; end
  def _cancan_skipper=(val); end
  def _cancan_skipper?; end
  def _layout(lookup_context, formats); end
  def admin_line_item_attributes; end
  def admin_line_item_attributes=(val); end
  def admin_line_item_attributes?; end
  def current_api_user; end
  def current_api_user=(arg0); end
  ...
  def self.admin_line_item_attributes; end
  def self.admin_line_item_attributes=(val); end
  def self.admin_line_item_attributes?; end
...
class Spree::Api::CheckoutsController < Spree::Api::BaseController
  def _layout(lookup_context, formats); end
  def self.__callbacks; end
  def self._helpers; end
  def self.middleware_stack; end
