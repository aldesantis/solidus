...
class ActiveJob::QueueAdapters::TestAdapter
  ...
  def job_to_hash(job, extras = nil); end
  def perform_enqueued_at_jobs; end
  def perform_enqueued_at_jobs=(arg0); end
  def perform_enqueued_jobs; end
  def perform_enqueued_jobs=(arg0); end
  def perform_or_enqueue(perform, job, job_data); end
  def performed_jobs; end
  def performed_jobs=(arg0); end
  def queue; end
  def queue=(arg0); end
  def reject; end
  def reject=(arg0); end
